...
From now, go to [brew.sh](https://brew.sh/) to retrieve the commands to install your favorite apps. 
...
Iterm2 as the nicest terminal for mac. dont use it very much but way nicer than the native terminal app
VS Code. In your mac terminal, run: 
```{r}
#| echo: true
#| code-fold: true
#| eval: false
